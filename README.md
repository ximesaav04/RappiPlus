...
Análisis end-to-end del desempeño de **RappiPlus**, una plataforma de e-commerce, transformando datos en insights accionables para apoyar decisiones de negocio: desde la calidad de datos hasta la comunicación de resultados en dashboards interactivos.
...
Los datasets se cargan desde una URL pública dentro del notebook, por lo que el análisis puede ejecutarse directamente sin necesidad de descargar archivos adicionales. La celda de conexión a base de datos usa credenciales de ejemplo (`YOUR_DB_USER`, `YOUR_DB_PASSWORD`) — en un entorno real estas se manejan mediante variables de entorno.
